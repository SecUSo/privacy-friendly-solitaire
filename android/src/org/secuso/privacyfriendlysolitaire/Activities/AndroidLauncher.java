...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
        ...
        final Application_maybe_later_Controller controller = new Application_maybe_later_Controller();
		...
		GLSurfaceView20 gameView =
				(GLSurfaceView20) initializeForView(controller, new AndroidApplicationConfiguration());
